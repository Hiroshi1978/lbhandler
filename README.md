...
You can also launch new web server instance from configuration file assuming that you specified required keys,that are 'ec2.default.imageid', 'ec2.default.instancetype' and 'ec2.default.zonename'.
